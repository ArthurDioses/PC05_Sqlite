...
public final class Constant {
    public final static String BASE_URL = "http://192.168.0.13:8080/bdupn/";
    ...
    public final static String ENDPOINT_SEARCH_BY_DNI = BASE_URL + "/buscar_por_codigoupn.php?dni=";
